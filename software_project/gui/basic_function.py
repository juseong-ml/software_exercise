...
def sort_img(): #모든 파일 목록을 가져오기
    ...
    for file in image_list:
        temp_list = file[0].split('_') #파일명중 "_"로 분리하여 리스트화
    ...
    # print(path_before)
    # folderlist = os.listdir(txt_dest_path)
    ...
    for file in filelist:
        ...
        dict[file] = temp_list[-1]  # {'파일명' : '분류'} 형태의 딕셔너리 생성
    print(file_list)
...
#가로 넓이 옵션
#가로 넓이 레이블
lbl_width = Label(frame_optiom, text='가로넓이', width=8)
lbl_width.pack(side='left',padx=5,pady=5)
#가로 넓이 콤보
opt_width = ['원본유지', '1024', '640']
