...
img = Image.open('images/yen_001.jpg')

if 'exif' not in img.info.keys(): # 이미지 파일에 exif 메타정보가 없으면 생성하고
    zeroth_ifd = {piexif.ImageIFD.Make:u"yen_n_fit",
    ...
    first_ifd = {piexif.ImageIFD.Make:u"yen",
    ...
    piexif.insert(exif_bytes, 'images/yen_001.jpg')

else: # 메타 정보가 있으면 270번 위치에 원하는 텍스트를 부여한 후, 저장한다.
    exif_dict = piexif.load(img.info['exif'])
    exif_dict['0th'][270] = u'yen'
    exif_bytes = piexif.dump(exif_dict)
    new_file = 'sorted/yen/yen_001.png'
